...
public class Searchproduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Product Name", "Quntatity", "price", "mfd", "exp", "Price per unit"
            }
        ) {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         ...
         DefaultTableModel model = (DefaultTableModel) table.getModel();
           try {
            Class.forName("");
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/java_stock", "root", "system");
