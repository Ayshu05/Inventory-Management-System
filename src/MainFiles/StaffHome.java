...
public class StaffHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DeleteStock.setText("REMOVE STOCK");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(AddStock, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ViewStock, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(47, 47, 47)
                .addComponent(BILLING, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(193, 193, 193))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(11, 11, 11)
                                .addComponent(BILLING, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(62, 62, 62)
                                .addComponent(UpdateStock)))
                        .addGap(34, 34, 34)
                        .addComponent(DeleteStock, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE))
    ...
    private void ViewStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewStockActionPerformed
        ...
        ViewStockStaff viewstock = new ViewStockStaff();
        this.dispose();
    ...
    private void AddStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddStockActionPerformed
        // TODO add your handling code here:
        addproductStaff addprod= new addproductStaff();
        this.dispose();
    ...
    private void UpdateStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateStockActionPerformed
        // TODO add your handling code here:
        updateStockStaff updatestock = new updateStockStaff();
        this.dispose();
    ...
    private void DeleteStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteStockActionPerformed
        // TODO add your handling code here:
        DelProductStaff delproduct = new DelProductStaff();
        this.dispose();
